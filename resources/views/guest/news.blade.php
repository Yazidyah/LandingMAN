    ...
    <div class="mt-8 grid grid-cols-12 gap-4">
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm col-span-12 md:col-span-6 lg:col-span-4">
            ...
            <div class="p-5">
                ...
                <p class="mb-3 font-normal text-gray-700">{{ ($item->created_at)->isoFormat('dddd, D MMMM YYYY') }}</p>
                <a href="{{ route('guest.newsDetail', $item->slug) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-tertiary rounded-lg hover:bg-secondary hover:text-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Baca lebih lanjut
