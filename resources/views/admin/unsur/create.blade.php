...
<div id="createModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <!-- Modal body -->
            <form id="createForm" class="p-4 md:p-5" method="POST" action="{{ route('admin.unsur.store') }}"
                enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div class="col-span-1">
                        <label for="unsur_name" class="block mb-2 text-sm font-medium text-gray-900">Nama Unsur</label>
                        <input type="text" name="unsur_name" id="unsur_name"
                            ...
                            placeholder="Masukkan nama unsur" required>
                    </div>
                    <div class="col-span-1">
