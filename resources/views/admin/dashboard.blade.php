        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            <div class="p-2 bg-lime-500 rounded-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                            </div>
                            <h4 class="ml-3 text-lg font-semibold text-gray-800">Visi Misi</h4>
                        </div>
                        <p class="text-gray-600 mb-4">Kelola visi & misi sekolah</p>
                        <a href="{{ route('admin.visimisi.index') }}" class="inline-flex items-center px-4 py-2 bg-lime-500 hover:bg-lime-600 text-white rounded-md transition-colors duration-200">
                            <span>Kelola</span>
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
