        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            @foreach ($contents as $content)
                <div name="banner" data-id="{{ $content->id }}"
                    ...
                    <button type="button" onclick="document.getElementById('deleteModal-{{ $content->id }}').classList.remove('hidden')" class="bg-red-900 text-white p-2 rounded-full hover:bg-red-500 absolute top-0 right-0 mt-2 mr-2">
                    ...
                    <x-confirm-delete-modal 
                        :modalId="'deleteModal-' . $content->id"
                        :formAction="route('admin.banner.destroy', $content->id)"
