            ...
            <form id="createForm" class="p-4 md:p-5" method="POST" action="{{ route('admin.contents.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div class="col-span-1">
                        <label for="contentTitle" class="block mb-2 text-sm font-medium text-gray-900">Konten Title</label>
                    ...
                    <div class="col-span-1">
                        <label for="contentBody" class="block mb-2 text-sm font-medium text-gray-900">Konten Body</label>
