...
<div class="container mx-auto pt-5 px-4">
    <div class="my-4 bg-tertiary rounded-lg text-white text-center py-8 leading-tight">
        <h2 class="font-bold text-3xl md:text-4xl">Create New Survey</h2>
    </div>
    <form action="{{ route('admin.survey.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="survey_name" id="survey_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        <div class="mb-4">
