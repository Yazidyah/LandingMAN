...
<div id="editModal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full backdrop-blur-sm bg-gray-900 bg-opacity-50">
    <div class="relative p-4 w-full max-w-md">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <!-- Modal body -->
            <form id="editForm" class="p-4 md:p-5" method="POST" action="{{ route('admin.categories.update', $category->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div class="col-span-1">
                        ...
                        <input type="text" name="category_name" id="categoryName" value="{{ $category->category_name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                </div>
