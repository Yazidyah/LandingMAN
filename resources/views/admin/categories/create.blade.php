            ...
            <form class="p-4 md:p-5" action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div class="col-span-1">
                        ...
                        <input type="text" name="category_name" id="category_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 placeholder-gray-400" placeholder="Masukkan nama kategori" required>
                    </div>
                </div>
