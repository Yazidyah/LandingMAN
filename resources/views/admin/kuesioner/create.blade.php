            ...
            <form id="createForm" class="p-4 md:p-5" method="POST" action="{{ route('admin.kuesioner.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    ...
                    <div class="col-span-1">
                        ...
                        <textarea name="question_text" id="questionText" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 placeholder-gray-400" placeholder="Masukkan pertanyaan" required></textarea>
                    </div>
                </div>
