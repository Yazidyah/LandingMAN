                ...
                <form action="{{ route('admin.sejarah.store') }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="sejarah" id="sejarah" rows="6"
                            class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-lg ring-2 ring-tertiary">{{ $sejarah->body ?? '' }}</textarea>
                    </div>
