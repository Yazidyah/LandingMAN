...
<head>
    ...
    <style>
        ...
        .chat-box-header {
            ...
            background: #006316; /* Updated primary color */
            color: white;
        ...
        .chat-box-body-send {
            max-width: 70%; /* Bubble width adjusts to text length */
        ...
        .chat-box-body-receive {
            ...
            background: #e4e6eb; /* Bot message bubble color */
            color: black;
            padding: 10px 15px;
        ...
        .chat-box-footer {
            ...
            background: white; /* Match the chatbox background */
        }
        ...
        .chat-box-footer .send {
            cursor: pointer;
            font-size: 20px;
            color: #006316; /* Updated primary color */
        }
        .chat-button {
            padding: 25px 16px;
            background: #006316;
...
<body>
    ...
    <script>
        ...
        function appendMessage(content, sender) {
            ...
            const time = new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }); // Only hours and minutes
        ...
        sendButton.addEventListener('click', async function () {
            ...
            try {
                ...
                appendMessage(`Error: Unable to fetch response. ${error.message}`, 'bot');
            }
        });
